        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(SD.FrontDeckUser))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(SD.FrontDeckUser));
                    }
                    ...
                    else
                    {
                        ...
                        {
                            if (role == SD.FrontDeckUser)
                            {
                                await _userManager.AddToRoleAsync(user, SD.FrontDeckUser);
                            }
                            else
                            {
                                await _userManager.AddToRoleAsync(user, SD.FrontDeckUser);
